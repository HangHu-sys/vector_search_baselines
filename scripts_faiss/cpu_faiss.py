...
python cpu_faiss.py --faiss_index_path ../data/CPU_Faiss_indexes --dbname SIFT1M --index_key IVF1024,Flat --mode run_one --topK 100 --qbs 100 --use_gpu 0 --parametersets 'nprobe=1 nprobe=32 nprobe=64 nprobe=128'

optional: --nthreads 1

(2) Mode B: test the throughput of a set of nprobe & topK & qbs (coded in the code), and save to performance pickle:

python cpu_faiss.py --dbname SIFT1M --index_key IVF1024,Flat --mode run_all --nthreads 16 --nruns 3 --nprobe_max 64 --use_gpu 0 --perf_df_path perf_df.pickle
...
parser.add_argument('--mode', type=str, default='run_one', choices=['run_one', 'run_all'], help="run one experiment or run all configs")
