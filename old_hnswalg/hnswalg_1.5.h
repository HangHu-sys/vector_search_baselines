/* hnswalg_1.5.h
    multicand gradually increase from 1 to max_threads.
 */
...
//                    if (candidate_id == 0) continue;
    ...
    searchBaseLayerST(tableint ep_id, const void *data_point, size_t ef, BaseFilterFunctor* isIdAllowed = nullptr) const {
        ...
        while (!candidate_set.empty()) {
            ...
            /* write to log */
            std::ofstream logfile("../results/log_candcounter_ef100_M8.txt", std::ios::app);
            if (logfile.is_open()) {
                logfile << candidate_set.size() << std::endl;
            }
